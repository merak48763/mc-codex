data modify storage codex:archives root."minecraft:enchantment/protection" set value { \
  ...
  details: [ \
    ...
    {translate: "codex.desc.enchantment.protection.1", fallback: "%1$s Damage reduction"} \
  ], \
  bullets: ["none", "dot"], \
  ...
  insertions: [ \
    { \
      ...
      fallback: "+80%", \
      generic: {translate: "codex.generic.enchantment.protection.1", fallback: "+[4%% * lvl]"}, \
...
data modify storage codex:archives root."minecraft:enchantment/blast_protection" set value { \
  ...
  details: [ \
    {translate: "item.modifiers.armor", color: "gray"}, \
    {translate: "codex.desc.enchantment.blast_protection.1", fallback: "%1$s Explosion damage reduction"}, \
    {translate: "codex.desc.enchantment.blast_protection.2", fallback: "%2$s %3$s"} \
  ], \
  ...
  insertions: [ \
    { \
      ...
      fallback: "+80%", \
      generic: {translate: "codex.generic.enchantment.blast_protection.1", fallback: "+[8%% * lvl]"}, \
      base_style: {color: "#9999ff"} \
    }, \
    { \
      type: "lookup", values: ["+0.15", "+0.3", "+0.45", "+0.6", "+0.75", "+0.9"], \
      fallback: "+1", \
      generic: {translate: "codex.generic.enchantment.blast_protection.2", fallback: "+[0.15 * lvl]"}, \
      base_style: {color: "#9999ff"} \
    }, \
...
data modify storage codex:archives root."minecraft:enchantment/fire_protection" set value { \
  ...
  details: [ \
    {translate: "item.modifiers.armor", color: "gray"}, \
    {translate: "codex.desc.enchantment.fire_protection.1", fallback: "%1$s Fire damage reduction"}, \
    {translate: "codex.desc.enchantment.fire_protection.2", fallback: "%2$s %3$s"} \
  ], \
  bullets: ["none", "dot", "dot"], \
  context_type: "enchantment", \
  insertions: [ \
    { \
      type: "lookup", values: ["+8%", "+16%", "+24%", "+32%", "+40%", "+48%", "+56%", "+64%", "+72%"], \
      fallback: "+80%", \
      generic: {translate: "codex.generic.enchantment.fire_protection.1", fallback: "+[8%% * lvl]"}, \
      base_style: {color: "#9999ff"} \
    }, \
    { \
      type: "lookup", values: ["-15%", "-30%", "-45%", "-60%", "-75%", "-90%"], \
      fallback: "-100%", \
      generic: {translate: "codex.generic.enchantment.fire_protection.2", fallback: "-[15%% * lvl]"}, \
      base_style: {color: "#9999ff"} \
    }, \
...
data modify storage codex:archives root."minecraft:enchantment/projectile_protection" set value { \
  ...
  details: [ \
    {translate: "item.modifiers.armor", color: "gray"}, \
    {translate: "codex.desc.enchantment.projectile_protection.1", fallback: "%1$s Projectile damage reduction"} \
  ], \
  bullets: ["none", "dot"], \
  context_type: "enchantment", \
  insertions: [ \
    { \
      type: "lookup", values: ["+8%", "+16%", "+24%", "+32%", "+40%", "+48%", "+56%", "+64%", "+72%"], \
      fallback: "+80%", \
      generic: {translate: "codex.generic.enchantment.projectile_protection.1", fallback: "+[8%% * lvl]"}, \
      base_style: {color: "#9999ff"} \
    } \
  ] \
}
data modify storage codex:archives root."minecraft:enchantment/feather_falling" set value { \
  ...
  details: [ \
    {translate: "item.modifiers.armor", color: "gray"}, \
    {translate: "codex.desc.enchantment.feather_falling.1", fallback: "%1$s Fall damage reduction"} \
  ], \
  bullets: ["none", "dot"], \
  context_type: "enchantment", \
  insertions: [ \
    { \
      ...
      fallback: "+80%", \
      generic: {translate: "codex.generic.enchantment.feather_falling.1", fallback: "+[12%% * lvl]"}, \
      base_style: {color: "#9999ff"} \
    } \
  ] \
}
