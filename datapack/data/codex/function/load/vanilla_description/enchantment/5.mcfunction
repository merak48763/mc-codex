data modify storage codex:archives root."minecraft:enchantment/sweeping_edge" set value { \
  ...
  details: [ \
    ...
    {translate: "codex.desc.enchantment.sweeping_edge.1", fallback: "%1$s %2$s"} \
  ], \
  bullets: ["none", "dot"], \
...
data modify storage codex:archives root."minecraft:enchantment/luck_of_the_sea" set value { \
  ...
  button_color: 11141375, \
  details: [ \
    {translate: "codex.desc.enchantment.luck_of_the_sea.1", fallback: "Applied to fishing result drawing:"}, \
    {translate: "codex.desc.enchantment.luck_of_the_sea.2", fallback: "%1$s %2$s"} \
  ], \
...
data modify storage codex:archives root."minecraft:enchantment/efficiency" set value { \
  ...
  details: [ \
    {translate: "item.modifiers.mainhand", color: "gray"}, \
    {translate: "codex.desc.enchantment.efficiency.1", fallback: "%1$s %2$s"} \
  ], \
  bullets: ["none", "dot"], \
  context_type: "enchantment", \
  insertions: [ \
...
data modify storage codex:archives root."minecraft:enchantment/respiration" set value { \
  ...
  details: [ \
    ...
    {translate: "codex.desc.enchantment.respiration.1", fallback: "%1$s %2$s"} \
  ], \
  bullets: ["none", "dot"], \
  context_type: "enchantment", \
  insertions: [ \
...
data modify storage codex:archives root."minecraft:enchantment/aqua_affinity" set value { \
  ...
  details: [ \
    {translate: "item.modifiers.head", color: "gray"}, \
    {translate: "codex.desc.enchantment.aqua_affinity.1", fallback: "%1$s %2$s"} \
  ], \
  bullets: ["none", "dot"], \
...
data modify storage codex:archives root."minecraft:enchantment/swift_sneak" set value { \
  ...
  details: [ \
    ...
    {translate: "codex.desc.enchantment.swift_sneak.1", fallback: "%1$s %2$s"} \
  ], \
  bullets: ["none", "dot"], \
  context_type: "enchantment", \
  insertions: [ \
    { \
      ...
      fallback: "+0.7", \
      generic: {translate: "codex.generic.enchantment.swift_sneak.1", fallback: "+[0.15 * lvl]"}, \
      base_style: {color: "#9999ff"} \
    }, \
...
data modify storage codex:archives root."minecraft:enchantment/depth_strider" set value { \
  ...
  details: [ \
    ...
    {translate: "codex.desc.enchantment.depth_strider.1", fallback: "%1$s %2$s"} \
  ], \
  bullets: ["none", "dot"], \
  context_type: "enchantment", \
  insertions: [ \
    { \
      ...
      fallback: "+1", \
      generic: {translate: "codex.generic.enchantment.depth_strider.1", fallback: "+[lvl / 3]"}, \
      base_style: {color: "#9999ff"} \
    }, \
